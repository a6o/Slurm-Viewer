...
class Slurm(App):
    ...
    async def action_refresh(self) -> None:
        ...
        if not self.partition_cycle:
            self.partition_cycle = cycle(list(data_of_partition.keys())[1:] + ['all'])
    ...
    def action_help(self):
        self.push_screen(InfoScreen("This is info screen, I have nothing to say."))
